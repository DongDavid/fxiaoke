...
trait PreSetObj
{
    protected $urlQuery = 'https://open.fxiaoke.com/cgi/crm/v2/data/query';
    protected $urlGet = 'https://open.fxiaoke.com/cgi/crm/v2/data/get';
    protected $urlCreate = 'https://open.fxiaoke.com/cgi/crm/v2/data/create';
    protected $urlUpdate = 'https://open.fxiaoke.com/cgi/crm/v2/data/update';
    protected $urlDelete = 'https://open.fxiaoke.com/cgi/crm/v2/data/delete';
    protected $urlInvalid = 'https://open.fxiaoke.com/cgi/crm/v2/data/invalid';
